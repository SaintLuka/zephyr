// Динамическая ORB декомпозиция без адаптации. Можно проверить динамическую балансировку
// на различных сетках, включая неструктурированные сетки из многоугольников.
