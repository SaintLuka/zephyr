/// @file Тест производительности многопоточности при работе с векторными
...
/// boost::container::small_vector -- Вектор имеет содержит буфер константного
/// размера, при превышении размеров данные переносятся в динамическую память.
///
/// Задача возникла при расчетах многоматериальных течений, в даннных задачах
...
/// @brief Простой класс для хранения вектора
/// @tparam container Тип хранения вектора
template <typename container>
class Vector {
public:
    Vector() {
