/// @brief Несколько простых утилит для поиска сечений в прямоугольниках и квадратах
#pragma once
...
/// @details Для двух ячеек с заданными объемными долями и общей гранью
/// существует единственная прямая, которая пересекает общую грань между
/// ячейками и отсекает от ячеек заданные объемные доли.
