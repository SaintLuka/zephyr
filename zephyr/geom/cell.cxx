...
Cell::Cell(const ShortList2D& verts) : dim(2) {
    build2D(verts);
}

Cell::Cell(const VerticesList& verts) : dim(2) {
    build2D(verts);
}

Cell::Cell(const LargeList2D& verts) : dim(2) {
    build2D(verts);
}

Cell::Cell(const ShortList3D& verts) : dim(3) {
    build3D(verts);
}

/*
Cell::Cell(const std::array<Storage::iterator, 4>& children) : dim(2) {
    using topology::iww;

    LargeList2D vs = {
            children[0][vertices].list[iww(0, 0)],
            children[0][vertices].list[iww(2, 0)],
            children[1][vertices].list[iww(2, 0)],
            children[0][vertices].list[iww(0, 2)],
            children[0][vertices].list[iww(2, 2)],
            children[1][vertices].list[iww(2, 2)],
            children[2][vertices].list[iww(0, 2)],
            children[2][vertices].list[iww(2, 2)],
            children[3][vertices].list[iww(2, 2)]
    };
    build2D(vs);
}

Cell::Cell(const std::array<Storage::iterator, 8>& children) : dim(3) {
    using topology::iss;
    using topology::isw;

    ShortList3D vs = {
            children[iss(0, 0, 0)][vertices].list[isw(0, 0, 0)],
            children[iss(1, 0, 0)][vertices].list[isw(1, 0, 0)],
            children[iss(0, 1, 0)][vertices].list[isw(0, 1, 0)],
            children[iss(1, 1, 0)][vertices].list[isw(1, 1, 0)],
            children[iss(0, 0, 1)][vertices].list[isw(0, 0, 1)],
            children[iss(1, 0, 1)][vertices].list[isw(1, 0, 1)],
            children[iss(0, 1, 1)][vertices].list[isw(0, 1, 1)],
            children[iss(1, 1, 1)][vertices].list[isw(1, 1, 1)]
    };
    build3D(vs);
}
 */
