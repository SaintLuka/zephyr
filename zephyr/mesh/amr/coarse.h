...
template <int dim>
Children select_children(AmrCells& locals, int ic) {
...
parent_vs(AmrCells& cells, Children& children) {
    return {
...
void make_parent(AmrCells& locals, AmrCells& aliens, int rank, Children& children, index_t ip) {
