...
/// @details Старые ячейки (существовавшие до процедуры адаптации) в поле amrData.next
...
/// После проведения геометрической части адаптации (см. setup_geometry)
...
/// происходит на последнем этапе алгоритма адаптации.
///
