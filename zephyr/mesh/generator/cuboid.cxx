...
Cuboid::Cuboid(YAML::Node config)
    : Base("cuboid"),
      ...
      m_back_flag(FaceFlag::UNDEFINED), m_front_flag(FaceFlag::UNDEFINED) {
...
void Cuboid::set_boundary_flags(
    ...
    if (periodic_along_z()) {
        m_back_flag = m_front_flag = FaceFlag::PERIODIC;
    }
}
...
bool Cuboid::periodic_along_z() const {
    return m_back_flag == FaceFlag::PERIODIC || m_front_flag == FaceFlag::PERIODIC;
}
